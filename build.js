...
concat({
	...
	dest : 'build/backbone.input.motion.js'
});


// - Validate js
lint('build/backbone.input.motion.js', function(){

	// - Create / save minified file
	uglify('build/backbone.input.motion.js', 'build/backbone.input.motion-min.js');
